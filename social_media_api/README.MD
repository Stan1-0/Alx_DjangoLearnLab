...
The application uses a **custom user model** (`CustomUser`) extending Django’s authentication system.
...
## 1️⃣ List Posts (Authenticated User Only)
